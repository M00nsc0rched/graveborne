...
const SKILLS = {
  strike:      { name:'Strike',       type:'attack', cost:0, power:12, desc:'A reliable melee blow.' },
  guard:       { name:'Guard',        type:'defend', cost:1, shield:'def2', desc:'Raise a shield (DEF×2 + honor).' },
  shieldbash:  { name:'Shield Bash',  type:'attack', cost:1, power:8,  effect:{stun:0.5}, desc:'A stunning bash.' },
  rally:       { name:'Rally',        type:'buff',   cost:2, effect:{regen:{amt:4,turns:3}, atkbuff:{amt:4,turns:3}}, desc:'Steel yourself: regen + ATK up.' },
  backstab:    { name:'Backstab',     type:'attack', cost:2, power:20, effect:{crit:0.5}, desc:'Vicious strike, often critical.' },
  poisonblade: { name:'Poison Blade', type:'attack', cost:2, power:10, effect:{poison:{dmg:4,turns:3}}, desc:'Venom-coated cut.' },
  bleed:       { name:'Rend',         type:'attack', cost:2, power:9,  effect:{poison:{dmg:5,turns:3}}, desc:'Open a bleeding wound.' },
  firebolt:    { name:'Hollow Fire',  type:'magic',  cost:2, power:16, desc:'Hurl a bolt of cold flame.' },
  hex:         { name:'Hex',          type:'magic',  cost:2, power:8,  effect:{weaken:{amt:5,turns:3}}, desc:'Curse the foe; its ATK falls.' },
  drain:       { name:'Life Drain',   type:'magic',  cost:3, power:14, effect:{lifesteal:0.6}, desc:'Siphon the foe\'s vitality.' },
...
const CLASSES = {
  ...
  rogue: {
    ...
    base:{ hp:44, sp:8, atk:16, def:6, mag:6, spd:12 }, honor:0,
  ...
  mage: {
    ...
    base:{ hp:38, sp:12, atk:6, def:5, mag:18, spd:8 }, honor:-20,
    skills:['firebolt','hex','drain','heal'],
  ...
  warden: {
    ...
    base:{ hp:50, sp:9, atk:11, def:10, mag:12, spd:7 }, honor:40,
